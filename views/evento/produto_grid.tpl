            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1>{$title}</h1>
                            <form role="form" action="/evento/produto_save" method="POST" enctype="multipart/form-data">
                    ...
                    <tbody>
                        {foreach from=$produto item="linha"}
                            <tr>                                                                
                                ...
                                <td>                   gg
                                    <a href="/evento/produto_delete/id_evento/{$linha.id_evento}" class="del">Deletar</a>
                                </td>
                            </tr>
                        {foreachelse}
